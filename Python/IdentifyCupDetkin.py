...
camera = PiCamera()
#img = cv2.imread("Images/try4.png")
camera.start_preview()
sleep(2)
camera.capture('Images/notCus.png')
camera.stop_preview()

img = cv2.imread("Images/cups.png")
...
imgCropped = imgResize[100:600,300:900] 
